      ...
      >
        ...
        <View style={styles.buttonGroup}>
          <ButtonGroup
            ...
            selectedIndex={post}
            onPress={(value) =>
              dispatch(AddPostSlice.actions.setPostType(value))
            }
        ...
        <View style={styles.buttonGroup}>
          <ButtonGroup
            ...
            selectedIndex={room}
            onPress={(value) =>
              dispatch(AddPostSlice.actions.setRoomType(value))
            }
            textStyle={{ fontSize: 15, fontWeight: "bold" }}
          />
        </View>
        <View style={{ flexDirection: "row", justifyContent: "flex-start" }}>
          <View style={{ flex: 1 }}>
            ...
            <TextInput
              ...
              value={roomPrice}
              onChangeText={(text) =>
                dispatch(AddPostSlice.actions.setRentalPrice(text))
              }
          ...
          <View style={{ flex: 1 }}>
            ...
            <TextInput
              ...
              value={area}
              onChangeText={(text) =>
                dispatch(AddPostSlice.actions.setArea(text))
              }
              keyboardType="phone-pad"
            ></TextInput>
          </View>
