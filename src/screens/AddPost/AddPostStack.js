...
import { addPostLocationScreenSelector, addPostInfoScreenSelector, addPostImagesScreenSelector, addPostConfirmScreenSelector, addPostSelector, addPostThumbnailSelector } from '../../redux/selectors';
...
export default function AddPostStack() {
    ...
    const createMyNewMotel = async (navigation) => {
        try {
            ...
            let myNewMotel = {...addPostData, rentalPrice: parseInt(addPostData.rentalPrice), area: parseInt(addPostData.area)};
        ...
        <Stack.Navigator initialRouteName="Location" screenOptions={{
            ...
            <Stack.Screen 
                ...
                options={({ navigation }) => ({
                    ...
                    headerRight: () => (
                        <TouchableOpacity onPress={() => nextScreen(navigation, "Location")}>
