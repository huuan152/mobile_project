  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        ...
        options={{ title: "Phòng đã đăng" }}
      />
      <Stack.Screen
        name="AreaTrackingScreen"
        component={AreaTrackingScreen}
        options={{ title: "Theo dõi khu vực" }}
      />
      <Stack.Screen
        name="UpdatePostStack"
        component={UpdatePostStack}
      ...
      <Stack.Screen
        ...
        options={{ headerShown: false }}
        initialParams={{ prev: "MyPostScreen" }}
      />
    </Stack.Navigator>
  );
};
